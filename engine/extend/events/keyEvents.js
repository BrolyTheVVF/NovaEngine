...
if(document){
	document.onkeydown = function(e){
		if(isDown(e.which) == false)/* Si cet key n'etait pas pressé auparavant, alors on peu exécute le code et peut être bouclé jusqu'à ce qu'elle ne soit plus pressé. */
		{
